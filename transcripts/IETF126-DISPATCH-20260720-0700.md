...
[00:08:10] **Dennis Jackson / Aaron Parekhi**: okay.
...
[00:16:44] **Jordi Recuenco**: Thank you.
...
[00:19:46] **John Peterson**: Good enough. How's it going, man? Good. I'm gonna have to pick this up, I think, because it's a little little short from the floor. Yeah. So I actually, I came up here to ask kind of a meta, more process question. Because you as you point out, this isn't the first time that we've considered dial back authentication here in the ITF. And in fact, how many dispatches ago was it that we were discussing Hao Feng's draft? Like, which does dial back authentication?

[00:20:08] **Ted Hardie**: Yeah. This is

[00:20:08] **Roger Anderson**: brand new to me.

[00:20:09] **John Peterson**: Oh, no. Got it. But I from a process perspective, kind of how, you know, do we need, like, a draft about how dialback authentication has a couple of known drawbacks, right? And one of them is this, it's not merely the ghost string. It's that people will exploit the ghost string for reflection attacks and amplification attacks, especially in a SIP environment. You can get forking. You can target someone by spoofing their number and make sure that they're, you know, DDoSed, basically, by this. And the divergence of the authority of of originators from forward routing, which occurs in a number of extremely, you know, common use cases that involve large enterprises. And so, you know, I guess, yeah, we've already considered an idea that's quite similar to this, and even earlier considered in the STIR context, like Jonathan's version of this, like, you know, I feel like we've already dispatched this, I guess is kind of what I'm saying. And so You feel like, what's that? We've already dispatched.

[00:21:01] **Roger Anderson**: We've already dispatched

[00:21:01] **John Peterson**: it, This got

[00:21:02] **Mohamad Khalil**: the idea.
...
[00:21:21] **Roger Anderson**: The phantom and ring, the reflection attack.
...
[00:33:14] **Dennis Jackson / Aaron Parekhi**: Okay.
...
[00:36:06] **Dennis Jackson / Aaron Parekhi**: Yeah. I mean, plus one's what like I said, this seems like it needs a a bunch of improvement from the cryptography design, and I don't see that happening in an AD sponsored draft. It seems like it needs a bunch of work. Yeah.
...
[00:45:08] **John Clemson**: I should note that I can't look at the chat session and talk at the same time. So
...
[00:45:35] **John Clemson**: That would certainly work for me.
...
[00:46:19] **John Clemson**: I'm certainly going to work on it, but a series of recent discussions have demonstrated that I don't know nearly enough about the deep details in this area nor about where things are deployed where they're not deployed to take a leadership role. Okay.
...
[00:47:28] **John Clemson**: No. No. Absolute agreement. And that's why I think we're looking ultimately for for BCP or applicability statement or a combination of the two that really talks about what the balances are and gives some useful advice.
...
[00:50:10] **John Clemson**: And and one of the key issues here one of the key issues here, I think, is that we need to look carefully at the balance between deliverability of email and and and confidentiality. And that's to a certain extent of of special case, which I just mentioned.
...
[01:00:32] **Steven Farrell**: Hi, Steven Pearl. I totally agree with Ted. In in addition, I think the vision here that seems to be behind us is that there's an MLS group that kinda everybody who's has a child is supposed to join, and every piece of software is supposed to only do what this MLS group says to do, that's kinda nonsense. This should go to to ITU something.

[01:00:54] **Jim Fenton**: Just a reminder for everybody at the microphone, please announce your names. Phil

[01:01:00] **Phillip Hallam-Baker**: Hambaker. I have a bit of experience in this area. Over 30 ago, was at W3C when we were developing PICCs. And the thing that I noticed with PICCs was there are a large number of people who were part of the group that should on no account be allowed anywhere near censorship system. And so I rewrote the PIX back when the guy in charge of it was out of the office, which upset him. And that's where we got the URI to describe your censorship scheme came from.

[01:01:41] **Raffat Sheikh Yousef**: So so, Phil, what's what's the dis

[01:01:44] **Phillip Hallam-Baker**: Well, the point was that the minute that that went into the spec, all the people who had been part of pushing BICS forwards disappeared because what they wanted all along was not what they said they wanted. It was control. And we don't do control, and I don't think that we should do this.
...
[01:07:45] **Raffat Sheikh Yousef**: What the most
...
[01:08:40] **Andrew Campling**: As I said, we're in discussions with a number of bodies who are interested in doing this. At least one of them is a major device manufacturer, but I can't say yet who that is because that's obviously up to them if and when they want to be public. But in case you missed it, Eka, in any case, Vodafone Group has got about 350,000,000 customers. Korea's got about 30,000,000 customers. So given the usual hurdle for dispatch, is is there at least some interest from third parties? Yeah. That's the best part of 400,000,000 users worth of interest, which I think is a decent start.
...
[01:18:11] **Jordi Recuenco**: So I'm just trying to understand the last question.
...
[01:19:12] **Raffat Sheikh Yousef**: What's the what's the dispatch? Like, what do you wanna do?
...
[01:20:04] **Raffat Sheikh Yousef**: So what what should we do with the useful stuff, Faker?
...
[01:20:21] **Raffat Sheikh Yousef**: From a dispatch perspective?

[01:20:23] **Eric Rescorla**: Nothing.

[01:20:23] **Raffat Sheikh Yousef**: Nothing. Perfect. Okay.
...
[01:31:17] **Dennis Jackson / Aaron Parekhi**: review.

[01:31:17] **Lun Li**: Okay. Thank you.

[01:31:18] **Jim Fenton**: Okay. Thank you. Aaron.

[01:31:23] **Dennis Jackson / Aaron Parekhi**: Hi. Aaron Parekhi. Have you considered bringing this to the MCP foundation in the Linux foundation to actually work on this in MCP?

[01:31:35] **Eliot Lear**: Oh, sorry.

[01:31:38] **Roger Anderson**: So did did you

[01:31:39] **Raffat Sheikh Yousef**: consider taking this to the MCP foundation?

[01:31:42] **Lun Li**: Oh, I think we that that might be yeah. That might be one of the one of the possibility also. Yeah.

[01:31:53] **Dennis Jackson / Aaron Parekhi**: Yeah. It seems like this might be a good fit there. I'm not a 100% sure, but that's possible dispatch. Okay.
...
[01:43:25] **Raffat Sheikh Yousef**: Yeah. Understood.
...
[01:44:43] **Shuping Peng**: Okay. This one. Mean, I I I think now people start channeling about the the outcome. Just one of the one of these.
