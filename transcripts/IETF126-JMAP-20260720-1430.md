...
[00:18:05] **Mauro Stettler**: That would be very great.
...
[00:39:59] **Phillip Hallam-Baker**: Okay. Yeah. That that that's my preferred approach as well. I mean, if nobody's screaming yeah. I mean, there's breaking the spec, and there is breaking running code. And I think it's pretty clear that we're not

[00:40:13] **Bron Gondwana**: gonna break any running code.

[00:40:14] **Robert Stepanek**: I think we should not be afraid of bumping major versions, especially not in this early stage of JS content. And as I said, this this exactly goes in the direction of that we started from what we had in vCart, but we can improve on what we think is makes more sense in reality.

[00:40:31] **Bron Gondwana**: The the

[00:40:31] **Phillip Hallam-Baker**: the the one tweak here is that this set of capabilities are something that you will be able to do with JSContact that you cannot currently do with vCard. And so once we put it out into the wild, then we may the curtain will probably come down, and it will start you know, if it takes off.
...
[00:43:06] **Jim Fenton**: You wanna do milestones?
...
[00:44:56] **Mauro Stettler**: But, yes, put everything on our view.
...
[00:45:28] **Phillip Hallam-Baker**: like it to be done before next meeting. So
...
[00:45:35] **Bron Gondwana**: I'm like Tomorrow. No. No. Draft-ietf. IETf-ietf-, that's what it'll be. Yep. X v card for this. There we go. Alright. Are there any other milestones we have at the moment?

[00:46:06] **Robert Stepanek**: Nine five five this Should have same milestone as we got for this.

[00:46:19] **Jim Fenton**: November.
...
[00:46:51] **Jim Fenton**: You need to unshare first.

[00:46:52] **Bron Gondwana**: Sorry. Let me go back here and drop that. Yep.

[00:47:03] **Jim Fenton**: We wanna go back to chair side?
...
[00:47:32] **Jim Fenton**: like limited edition a limited number of these. So I just bought the introductory size pack to see what the stickers were like. So they're
...
[01:03:47] **Mauro Stettler**: No. What what I'm saying
...
[01:06:17] **Mauro Stettler**: Also, you were so your question, if it simplifies our handler, my my reply was how to handle errors. No. It does not simplify. Yeah. You just said no. No. It does not. It's it's just about this it's about saving round trip to the server, this extension. Yeah. Alexi.
...
[01:08:27] **Mauro Stettler**: know? Okay.
...
[01:08:49] **Mauro Stettler**: Yeah. Yeah. That's something we need to say.
...
[01:10:10] **Jim Fenton**: Anyone? Has
...
[01:22:04] **Bron Gondwana**: Yes. Diffing or if you're doing range based rights, you can also you can upload use the Blobxt combining. So you say copy this range from the old Blob ID and then put this little bit of data and then copy the rest from the Blob ID. And my server implementation does chunking on that, so a chunk that hasn't been touched just gets maintained, and whichever chunks have been touched get rewritten.
...
[01:28:37] **Mauro Stettler**: Oh, definitely. I like the idea.

[01:28:39] **Bron Gondwana**: Yeah. Cool. And then for Blobxt, I think there's not anything to add to that. It's already it's already pretty busy. And for file note, obviously, there's plenty of work to do there, including potentially another another document around the changes or some some updates to the state stuff.
...
[01:34:36] **Alexey Melnikov**: Okay. I I think I'm encouraged by your comment to base it on Blobset, but I'm still a bit scared of Alright. Blobxt. It might be just going a little bit too much. Again, I'm up convert. Up up. We did this and I'll buy you
...
[01:40:04] **Mauro Stettler**: Yeah. Yeah. I mean, you can
...
[01:50:25] **Jim Fenton**: Stickers available upfront. Just a few, though.
